...
* Image tagging, changing DC config does not results into
* immediate update.
* */
...
* Image tagging, changing DC config all this config changes
* results into single update rather than rolling an update multiple times.
* */
